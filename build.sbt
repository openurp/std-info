...
val apiVer = "0.46.0-SNAPSHOT"
val starterVer = "0.3.63-SNAPSHOT"
val baseVer = "0.4.55-SNAPSHOT"
val stdCoreVer = "0.0.23-SNAPSHOT"
...
lazy val root = (project in file("."))
  ...
  .settings(
    ...
    common,
    libraryDependencies ++= Seq(openurp_stater_web, beangle_ems_app),
