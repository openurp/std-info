...
[@b.form action=b.rest.save(stdAlterConfig) title="学籍类型异动维护" theme="list"]
    ...
    [@b.radios label="修改预计毕业日期"   name="stdAlterConfig.alterGraduateOn" value=stdAlterConfig.alterGraduateOn required="true" style="width:200px"/]
    [@b.radios label="异动后学籍立即失效"   name="stdAlterConfig.alterEndOn"  value=stdAlterConfig.alterEndOn required="true" style="width:200px"/]
