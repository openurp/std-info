...
[@b.div id="studentDiv"]
  <div style="width:60%;margin-left:auto;margin-right:auto;background-color:#E1ECFF;text-align:center">
    ...
    <div>
          ...
          <td style="background-color:#e8eefa;"[#if (student_index % 3) lt 2] width="${ 100 / 3 }%"[/#if]>
            <table width="100%">
                <tr>
                  ...
                  <td><a href="${b.url("studentInfo!info.action?studentId=" + student.id)}" title="查看学生详细信息" target="_blank">${(student.user.code)!}</a></td>
                </tr>
                <tr>
      ...
      <div align="center" style="color:#666666;background:#E1ECFF; border-color: #006CB2;border-width: 1px; border-style: solid"><b>该班级没有学生!</b></div>
      [/#if]
    </div>
  </div>
[/@]
