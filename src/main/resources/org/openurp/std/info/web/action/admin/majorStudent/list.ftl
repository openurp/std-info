...
[@b.grid items=majorStudents var="majorStudent"]
  ...
  [@b.row]
    ...
    [@b.col width="15%" property="school.name" title="主修学校"/]
    [@b.col width="18%" property="majorName" title="主修专业"/]
    [@b.col property="enMajorName" title="主修专业英文名"/]
    [@b.col width="8%" property="majorCategory.name" title="学科门类"/]
  [/@]
  [/@]
[@b.foot/]
